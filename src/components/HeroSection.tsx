      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <button className="bg-olive-green text-white px-8 py-4 rounded-lg font-semibold hover:bg-opacity-90 transition-all duration-300 flex items-center justify-center space-x-2 hover-scale">
                <ShoppingCart size={20} />
                <span>Shop Now</span>
              </button>
              <button className="border-2 border-olive-green text-olive-green px-8 py-4 rounded-lg font-semibold hover:bg-olive-green hover:text-white transition-all duration-300">
                Learn More
              </button>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-lg">
              <p className="text-sm font-semibold text-rich-brown">Made from</p>
              <p className="text-olive-green font-bold">A2 Cow Milk</p>
            </div>
          </motion.div>
        </div>
      </div>
