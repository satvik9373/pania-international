          ...
          <section className="py-20 bg-cream">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-5xl font-bold text-rich-brown mb-8">
                  Experience Pure<span className="text-olive-green">Harvest</span>
                </h2>
                ...
                <div className="grid md:grid-cols-3 gap-12 mt-16">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-rich-brown mb-4">Premium Quality</h3>
                    <p className="text-gray-600">Sourced from the finest farms across India with rigorous quality standards</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-rich-brown mb-4">100% Natural</h3>
                    <p className="text-gray-600">No preservatives, artificial colors, or harmful additives</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-rich-brown mb-4">Traditional Craft</h3>
                    <p className="text-gray-600">Time-honored processes passed down through generations</p>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-300">
                    ...
                    <li><a href="#" className="hover:text-olive-green transition-colors">Our Story</a></li>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-300">
                    ...
                    <li><a href="#" className="hover:text-olive-green transition-colors">Shipping Info</a></li>
              ...
              <div className="border-t border-gray-600 mt-12 pt-8 text-center">
                <p className="text-gray-300 text-lg">
                  © 2024 PureHarvest. All rights reserved. Crafted with passion in India.
                </p>
              </div>
            </div>
          </footer>
