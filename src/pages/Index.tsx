...
const Index = () => {
  ...
  return (
  <div className="min-h-screen" style={{ backgroundColor: isLoading ? '#2E3E27' : 'transparent' }}>
              ...
              >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 -gap-x-4 gap-y-4 sm:gap-x-6 sm:gap-y-5 lg:gap-x-8 lg:gap-y-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-base sm:text-xl text-white mb-2">100% Clean</h3>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-base sm:text-xl text-white mb-2">Farm Fresh</h3>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-base sm:text-xl text-white mb-2">Made in Small Batches</h3>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-base sm:text-xl text-white mb-2">Rooted in Tradition</h3>
                  </div>
                </div>
              </motion.div>
            </div>
