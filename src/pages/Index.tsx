              ...
              <div className="grid md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li><a href="#" className="hover:text-olive-green transition-colors tracking-normal">About Us</a></li>
                    <li><a href="#" className="hover:text-olive-green transition-colors tracking-normal">Products</a></li>
                    <li><a href="#" className="hover:text-olive-green transition-colors tracking-normal">Our Story</a></li>
                    <li><a href="#" className="hover:text-olive-green transition-colors tracking-normal">Contact</a></li>
                  </ul>
                </div>
                <div>
