  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 text-lg">
                    Comprehensive global trade solutions for premium natural products
                  </p>
                </div>
        ...
        {/* Separate Professional Services Section */}
        <section className="py-16 bg-olive-green text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-white/80 text-lg">
                    Specialized consulting and professional solutions across multiple industries
                  </p>
                </div>
                ...
                <div className="space-y-4 bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                  <div className="space-y-3 ml-6">
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-terracotta rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-white/90">Architectural Services</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-terracotta rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-white/90">Online & Offline Physiotherapy (U.K.)</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-terracotta rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-white/90">Fitness Coaching (Global)</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-terracotta rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-white/90">Temperature-Sensitive Logistics</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-terracotta rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-white/90">Pan-India Procurement & Shipment</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl">
                  <img
                    src="/service-img/professional-services.jpg"
